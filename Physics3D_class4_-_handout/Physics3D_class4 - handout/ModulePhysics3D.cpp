...
void ModulePhysics3D::Point2PointConstraint(PhysBody3D& A, PhysBody3D& B, vec3 anchor1, vec3 anchor2)
{
	btVector3 a1(anchor1.x,anchor1.y, anchor1.z);
	btVector3 a2(anchor2.x, anchor2.y, anchor2.z);
	btPoint2PointConstraint* p2p = new btPoint2PointConstraint(A.GetbtBody(), B.GetbtBody(), a1, a2);
	constraints.add(p2p);
